using System;
using DG_Pack.UI.Canvas.Query;
using UnityEngine;

namespace DG_Pack.UI.Canvas {
    public abstract class Handler<T> : IHandler where T : Component {
        protected Handler() : this(new SimpleQuery()) { }
        ...
        public virtual void Bind(Component parent) {
            if (parent == null)
